        ...
        return (
            <>
                ...
                <div className="flex justify-center items-center w-screen p-3">
                    {
                        showForm ? (<div className="flex flex-col">
                            <div className="relative">
                                <FontAwesomeIcon onClick={() => setShowForm(false)} icon={faXmarkCircle} className="absolute right-0 m-3 text-4xl text-red-500 hover:text-red-600 cursor-pointer"/>
                            </div>
                            <ProjectForm/>

                ...
                <div className="w-full md:w-3/4 h-3/4 border-2 border-white rounded-3xl p-4">
                    ...
                    <div className="flex flex-col w-full">
                        <div className="flex justify-between w-full">
                            ...
                            <input type="text" onChange={(e) => setAppName(e.target.value)} className="text-[10px] sm:text-lg md:text-2xl m-1 font-bold text-center text-blue-400" required />
                        </div>
                    </div>
                    <div className="flex flex-col w-full">
                        <div className="flex justify-between w-full">
                            <p className="text-sm sm:text-md md:text-2xl m-1 font-bold text-center text-blue-400">App Description</p>
                            <input type="text" onChange={(e) => setAppDescription(e.target.value)} className="text-[10px] sm:text-lg md:text-2xl m-1 font-bold text-center text-blue-400" required />
                        </div>
                    </div>
                    <div className="flex flex-col w-full my-4">
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <button onClick={() => { tech != "" ?(setTechStack([...techStack, tech])): (alert("Enter Tech")) }} onKeyDown={
                                (e) => {
                                    if (e.key === "Enter") {
                                        tech != "" ?(setTechStack([...techStack, tech])): (alert("Enter Tech"));
                                    }
                                }
                            } className="text-md md:text-2xl m-1 bg-green-300 rounded-md font-bold text-center text-black">Add Tech</button>
                        </div>
                    </div>
                    <div className="flex flex-col w-full">
                        ...
                        <div className="flex justify-between w-full my-3">
                            ...
                            }} className="text-md md:text-2xl m-1 w-5 font-bold text-center text-blue-400" />
                        </div>
                        <div className="flex justify-between w-full my-3">
                    ...
                    <div className="flex flex-col w-full my-3">
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <button onClick={() => { feature != "" ? setUpcomingFeatures([...upcomingFeatures, feature]) : alert("Enter Feature") }} onKeyDown={
                                (e) => {
                                    if (e.key === "Enter") {
                                        e.target.value != "" ? setUpcomingFeatures([...upcomingFeatures, e.target.value]) : alert("Enter Feature");
                                    }
                                }
                            } className="text-md md:text-2xl m-1 bg-green-300 rounded-md font-bold text-center text-black">Add Feature</button>
                        </div>
                    </div>
                    <div className="flex justify-between w-full">
